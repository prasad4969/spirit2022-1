...
const EventSchema = new mongoose.Schema(
  {
    ...
    team_leader: [{ type: String, required: false, unique:false}],
    team_cnt: [{ type: Number, required: false, unique:false}],
    accomodation: [{ type: Boolean, required: false, unique:false}],
